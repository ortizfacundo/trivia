...
var questions = [
	[
		"¿Cómo podemos pagar nuestra tarjeta de crédito?",

		"Débito automático y Manualmente.",
        "Online Banking",
		"Cajero, Autoservicio,Rapipago, etc...",
		"Todas las respuestas son correctas",
		3
	],
	[
		"¿ Cuanto dígitos conforman el TD / CLAVE BANELCO / COD SEGURIDAD ?",

            "16 dígitos / 4 dígitos / 3 dígitos",
            "16 dígitos / 3 dígitos / 4 dígitos",
			"15 dígitos / 4 dígitos / 4 dígitos",
			"15 dígitos / 5 dígitos / 3 dígitos",
		0
	],
	[
		"¿Cuáles son los beneficios del débito automático?",
		"Te recuerda cuando pagar",
		"Ahorro de tiempo",
		"Estar siempre al día ",
		"Pagás por pago fácil",
		2
	],
	[
		"¿Cuántos tipos de transferencias existen?",
		"2",
		"3", 
		"7", 
	...
	[
		"¿Cuántos días después de la fecha de cierre se efectua la fecha de vencimiento?",
		"10",
		"9",
		"5",
		"20",
...
$(function() {
	...
	function start() {
		$('div.start').fadeOut(500, function() {
			moveToNextQuestion();
		});
	}
